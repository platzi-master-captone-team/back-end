                                    ...
                                    <tr style='box-sizing:border-box;'>
                                        <td
                                            ...
                                            <div class='logo'
                                                ...
                                                <img src='https://i.ibb.co/vcpx9V1/logo.png'
                                                    alt='Logo Consultify'
                                            ...
                                            <h1
                                                ...
                                                Cuenta Activada</h1><br style='box-sizing:border-box;'>
                                            <table class='table'
                                                ...
                                                <tbody style='box-sizing:border-box;'>
                                                    <tr style='box-sizing:border-box;'>
                                                        <td
                                                            ...
                                                            <p> Felicitaciones <strong>${data.user_name}</strong> </p>
                                                            </p>
                                                            <p>Ahora haces parte de la red de consultores más grande de latinoamerica.</p>
                                                            Ingresando en el siguiente enlace podrás acceder a todos los beneficios que <strong>Consultify</strong>
                                                            tiene para ti.
                                                        </p>
                                                        </td>
                                                    </tr>
                                            ...
                                            <a href="https://www.consultify.online/login"
                                                target='_blank' type='button' class='btn btn-success' name='button'
                                            ...
                                            <p
                                               ...
                                               Para mayor información contacta nuestro <a
                                                    ...
                                                    style='box-sizing:border-box;color:#007bff;text-decoration:none;background-color:transparent;'>equipo de soporte</a></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr style='box-sizing:border-box;'>
                                <td class='content-block'
                                    ...
                                    <span class='apple-link'
                                        style='box-sizing:border-box;color:#999999;font-size:12px;text-align:center;'>Consultify, &copy; 2021</span>
